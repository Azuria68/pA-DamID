------------------------------------------------------------------------------
# Script R - Analyse morphométrique d'objets segmentés (normalisation + tests)
#
# Ce script :
#   - charge des données morphologiques extraites par image (mesures d’objets),
#   - les normalise selon les dimensions des images,
#   - regroupe les données par condition (Spin1WT / KO2loxWT / KO2lox),
#   - génère des boxplots annotés avec tests statistiques (Kruskal-Wallis + Wilcoxon),
#   - exporte les figures (JPG) pour chaque mesure analysée.
#
# Auteur : Tom Lanchec
# ------------------------------------------------------------------------------
...
combined_data <- read_csv('/Users/tom/Documents/GitHub/pA-DamID/Scripts pA-DamID/Tubule')
...
print("Boxplots avec tests statistiques enregistrés")
